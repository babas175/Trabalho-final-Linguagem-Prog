...
subst x n (Primeiro e) = Primeiro (subst x n e)
subst x n (Segundo e) = Segundo(subst x n e)
...
step (MaiorOuIgual (Num n1) (Num n2)) = if (n1 >= n2) then 
                                 Just BTrue 
                               else 
                                 Just BFalse
step (MaiorOuIgual (Num n1) e2) = case step e2 of
                            Just e2' -> Just (MaiorOuIgual (Num n1) e2')
                            _        -> Nothing

step (MaiorOuIgual e1 e2) = case step e1 of
                      Just e1' -> Just (MaiorOuIgual e1' e2)
                      _        -> Nothing
